...
class FES_User_Url_Field extends FES_Field {
	...
	public function set_title() {
		$this->supports['title'] = apply_filters( 'fes_' . $this->name() . '_field_title', _x( 'User URL', 'FES Field title translation', 'edd_fes' ) );
	}
