...
class FES_Setup {
	...
	public function admin_enqueue_scripts() {
		...
		if ( is_object( $current_screen ) && isset( $current_screen->id ) && strlen( $current_screen->id ) > 5 && ( substr( $current_screen->id, 0, 7 ) === 'edd-fes' || $current_screen->id === 'toplevel_page_fes-vendors' ) ) {
			$is_fes_page = true;
...
?>
		...
		#toplevel_page_fes-vendors [data-icon]:before {
		...
		#toplevel_page_fes-vendors [class^="icon-"]:before,
		#toplevel_page_fes-vendors [class*=" icon-"]:before {
			font-family: "fes" !important;
			font-style: normal !important;
			font-weight: normal !important;
		...
		#adminmenu #toplevel_page_fes-vendors .menu-icon-generic div.wp-menu-image:before {
			font-family: "fes" !important;
			content: "a";
		}
		</style>
<?php
	...
	public function load_fields() {
		...
		require_once fes_plugin_dir . 'classes/fields/class-fes-telephone-number-field.php';
		require_once fes_plugin_dir . 'classes/fields/class-fes-number-field.php';
		...
		$fields = apply_filters( 'fes_load_fields_array',
			array(
				...
				'telephone_number'    => 'FES_Telephone_Number_Field',
				'text'                => 'FES_Text_Field',
