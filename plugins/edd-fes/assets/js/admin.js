jQuery(document).ready(function($) {
	...
	var FES_Vendor = {
		...
		delete_checked: function() {
			$( '#fes-vendor-delete-confirm' ).change( function() {
				var records_input = $('#fes-delete-all-content, #fes-attribute-to-other, #fes_user_list');
				var submit_button = $('#fes-delete-vendor');
